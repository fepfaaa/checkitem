...
local Check_Item = PepsiUi:CreateTab({
    Name = "ᴄʜᴇᴄᴋ ɪᴛᴇᴍ"
})
local Check_1 = Check_Item:CreateSection({
    Name = "[ Check Punch ]",
    Side = "Left"
})

local Superhuman = Check_1:AddLabel({
    Name = "❌ : Superhuman" -- ✅ ❌
})

local ElectricClaw = Check_1:AddLabel({
    Name = "❌ : ElectricClaw" -- ✅ ❌
})

local DragonTalon = Check_1:AddLabel({
    Name = "❌ : DragonTalon" -- ✅ ❌
})

local SharkmanKarate = Check_1:AddLabel({
    Name = "❌ : SharkmanKarate" -- ✅ ❌
})

local DeathStep = Check_1:AddLabel({
    Name = "❌ : DeathStep" -- ✅ ❌
})

local Godhuman = Check_1:AddLabel({
    Name = "❌ : Godhuman" -- ✅ ❌
})
...
local Check_2 = Check_Item:CreateSection({
    Name = "[ Check Sword ]",
    Side = "Right"
})
local Cursed_Dual_Katana = Check_2:AddLabel({
    Name = "❌ : Cursed Dual Katana" -- ✅ ❌
})
local Dark_Blade = Check_2:AddLabel({
    Name = "❌ : Dark Blade" -- ✅ ❌
})
local Hallow_Scythe = Check_2:AddLabel({
    Name = "❌ : Hallow Scythe" -- ✅ ❌
})
local True_Triple_Katana = Check_2:AddLabel({
    Name = "❌ : True Triple Katana" -- ✅ ❌
})
local Saber = Check_2:AddLabel({
    Name = "❌ : Saber" -- ✅ ❌
})
local Tushita = Check_2:AddLabel({
    Name = "❌ : Tushita" -- ✅ ❌
})
local Yama = Check_2:AddLabel({
    Name = "❌ : Yama" -- ✅ ❌
})
local Bisento = Check_2:AddLabel({
    Name = "❌ : Bisento" -- ✅ ❌
})
local Buddy_Sword = Check_2:AddLabel({
    Name = "❌ : Buddy Sword" -- ✅ ❌
})
local Canvander = Check_2:AddLabel({
    Name = "❌ : Canvander" -- ✅ ❌
})
local Dark_Dagger = Check_2:AddLabel({
    Name = "❌ : Dark Dagger" -- ✅ ❌
})
local Koko = Check_2:AddLabel({
    Name = "❌ : Koko" -- ✅ ❌
})
local Midnight_Blade = Check_2:AddLabel({
    Name = "❌ : Midnight Blade" -- ✅ ❌
})
local Pole_2 = Check_2:AddLabel({
    Name = "❌ : Pole (2nd Form)" -- ✅ ❌
})
local Pole_1 = Check_2:AddLabel({
    Name = "❌ : Pole (1st Form)" -- ✅ ❌
})
local Rengoku = Check_2:AddLabel({
    Name = "❌ : Rengoku" -- ✅ ❌
})
local Saddi = Check_2:AddLabel({
    Name = "❌ : Saddi" -- ✅ ❌
})
local Shisui = Check_2:AddLabel({
    Name = "❌ : Shisui" -- ✅ ❌
})
local Wando = Check_2:AddLabel({
    Name = "❌ : Wando" -- ✅ ❌
})
local Spikey_Trident = Check_2:AddLabel({
    Name = "❌ : Spikey Trident" -- ✅ ❌
})
local Dragon_Trident = Check_2:AddLabel({
    Name = "❌ : Dragon Trident" -- ✅ ❌
})

local Check_3 = Check_Item:CreateSection({
    Name = "[ Check Gun ]",
    Side = "Left"
})

local Soul_Guitar = Check_3:AddLabel({
    Name = "❌ : Soul Guitar" -- ✅ ❌
})
local Kabucha = Check_3:AddLabel({
    Name = "❌ : Kabucha" -- ✅ ❌
})
local Serpent_Bow = Check_3:AddLabel({
    Name = "❌ : Serpent Bow" -- ✅ ❌
})
local Acidum_Rifle = Check_3:AddLabel({
    Name = "❌ : Acidum Rifle" -- ✅ ❌
})

local Check_4 = Check_Item:CreateSection({
    Name = "[ Check Accessory ]",
    Side = "Left"
})

local Dark_Coat = Check_4:AddLabel({
    Name = "❌ : Dark Coat" -- ✅ ❌
})
local Holy_Crown = Check_4:AddLabel({
    Name = "❌ : Holy Crown" -- ✅ ❌
})
local Musketeer_Hat = Check_4:AddLabel({
    Name = "❌ : Musketeer Hat" -- ✅ ❌
})
local Pale_Scarf = Check_4:AddLabel({
    Name = "❌ : Pale Scarf" -- ✅ ❌
})
local Swan_Glasses = Check_4:AddLabel({
    Name = "❌ : Swan Glasses" -- ✅ ❌
})
local Valkyrie_Helm = Check_4:AddLabel({
    Name = "❌ : Valkyrie Helm" -- ✅ ❌
})
local Warrior_Helmet = Check_4:AddLabel({
    Name = "❌ : Warrior Helmet" -- ✅ ❌
})
	...
	pcall(function()
    	while wait(3) do
            ...
            if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw",true) == 1 then
                ElectricClaw:Set("✅ : ElectricClaw")
            else
                ElectricClaw:Set("❌ : ElectricClaw")
            end
            if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon",true) == 1 then
                DragonTalon:Set("✅ : DragonTalon")
            else
                DragonTalon:Set("❌ : DragonTalon")
            end
            if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate",true) == 1 then
                SharkmanKarate:Set("✅ : SharkmanKarate")
            else
                SharkmanKarate:Set("❌ : SharkmanKarate")
            end
            if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep",true) == 1 then
                DeathStep:Set("✅ : DeathStep")
            else
                DeathStep:Set("❌ : DeathStep")
            end
            ...
            for i, v in pairs(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventoryWeapons")) do
                for i2, v2 in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
					for i3,v3 in pairs(game.Players.LocalPlayer.Character:GetChildren()) do
						if v.Name == "Cursed Dual Katana" or v2.Name == "Cursed Dual Katana" or v3 == "Cursed Dual Katana" then
							Cursed_Dual_Katana:Set("✅ : Cursed Dual Katana")
						end
						if v.Name == "Dark Blade" or v2.Name == "Dark Blade" or v3 == "Dark Blade" then
							Dark_Blade:Set("✅ : Dark Blade")
						end
						if v.Name == "Hallow Scythe" or v2.Name == "Hallow Scythe" or v3 == "Hallow Scythe" then
							Hallow_Scythe:Set("✅ : Hallow Scythe")
						end
						if v.Name == "True Triple Katana" or v2.Name == "True Triple Katana" or v3 == "True Triple Katana" then
							True_Triple_Katana:Set("✅ : True Triple Katana")
						end
						if v.Name == "Saber" or v2.Name == "Saber" or v3 == "Saber" then
							Saber:Set("✅ : Saber")
						end
						if v.Name == "Tushita" or v2.Name == "Tushita" or v3 == "Tushita" then
							Tushita:Set("✅ : Tushita")
						end
						if v.Name == "Yama" or v2.Name == "Yama" or v3 == "Yama" then
							Yama:Set("✅ : Yama")
						end
						if v.Name == "Bisento" or v2.Name == "Bisento" or v3 == "Bisento" then
							Bisento:Set("✅ : Bisento")
						end
						if v.Name == "Buddy Sword" or v2.Name == "Buddy Sword" or v3 == "Buddy Sword" then
							Buddy_Sword:Set("✅ : Buddy Sword")
						end
						if v.Name == "Canvander" or v2.Name == "Canvander" or v3 == "Canvander" then
							Canvander:Set("✅ : Canvander")
						end
						if v.Name == "Dark Dagger" or v2.Name == "Dark Dagger" or v3 == "Dark Dagger" then
							Dark_Dagger:Set("✅ : Dark Dagger")
						end
						if v.Name == "Koko" or v2.Name == "Koko" or v3 == "Koko" then
							Koko:Set("✅ : Koko")
						end
						if v.Name == "Midnight Blade" or v2.Name == "Midnight Blade" or v3 == "Midnight Blade" then
							Midnight_Blade:Set("✅ : Midnight Blade")
						end
						if v.Name == "Pole (2nd Form)" or v2.Name == "Pole (2nd Form)" or v3 == "Pole (2nd Form)" then
							Pole_2:Set("✅ : Pole (2nd Form)")
						end
						if v.Name == "Pole (1st Form)" or v2.Name == "Pole (1st Form)" or v3 == "Pole (1st Form)" then
							Pole_1:Set("✅ : Pole (1st Form)")
						end
						if v.Name == "Rengoku" or v2.Name == "Rengoku" or v3 == "Rengoku" then
							Rengoku:Set("✅ : Rengoku")
						end
						if v.Name == "Saddi" or v2.Name == "Saddi" or v3 == "Saddi" then
							Saddi:Set("✅ : Saddi")
						end
						if v.Name == "Shisui" or v2.Name == "Shisui" or v3 == "Shisui" then
							Shisui:Set("✅ : Shisui")
						end
						if v.Name == "Wando" or v2.Name == "Wando" or v3 == "Wando" then
							Wando:Set("✅ : Wando")
						end
						if v.Name == "Spikey Trident" or v2.Name == "Spikey Trident" or v3 == "Spikey Trident" then
							Spikey_Trident:Set("✅ : Spikey Trident")
						end
						if v.Name == "Dragon Trident" or v2.Name == "Dragon Trident" or v3 == "Dragon Trident" then
							Dragon_Trident:Set("✅ : Dragon Trident")
						end
						if v.Name == "Soul Guitar" or v2.Name == "Soul Guitar" or v3 == "Soul Guitar" then
							Soul_Guitar:Set("✅ : Soul Guitar")
						end
						if v.Name == "Kabucha" or v2.Name == "Kabucha" or v3 == "Kabucha" then
							Kabucha:Set("✅ : Kabucha")
						end
						if v.Name == "Serpent Bow" or v2.Name == "Serpent Bow" or v3 == "Serpent Bow" then
							Serpent_Bow:Set("✅ : Serpent Bow")
						end
						if v.Name == "Acidum Rifle" or v2.Name == "Acidum Rifle" or v3 == "Acidum Rifle" then
							Acidum_Rifle:Set("✅ : Acidum Rifle")
						end
						if v.Name == "Dark Coat" or v2.Name == "Dark Coat" or v3 == "Dark Coat" then
							Dark_Coat:Set("✅ : Dark Coat")
						end
						if v.Name == "Holy Crown" or v2.Name == "Holy Crown" or v3 == "Holy Crown" then
							Holy_Crown:Set("✅ : Holy Crown")
						end
						if v.Name == "Musketeer Hat" or v2.Name == "Musketeer Hat" or v3 == "Musketeer Hat" then
							Musketeer_Hat:Set("✅ : Musketeer Hat")
						end
						if v.Name == "Pale Scarf" or v2.Name == "Pale Scarf" or v3 == "Pale Scarf" then
							Pale_Scarf:Set("✅ : Pale Scarf")
						end
						if v.Name == "Swan Glasses" or v2.Name == "Swan Glasses" or v3 == "Swan Glasses" then
							Swan_Glasses:Set("✅ : Swan Glasses")
						end
						if v.Name == "Valkyrie Helm" or v2.Name == "Valkyrie Helm" or v3 == "Valkyrie Helm" then
							Valkyrie_Helm:Set("✅ : Valkyrie Helm")
						end
						if v.Name == "Warrior Helmet" or v2.Name == "Warrior Helmet" or v3 == "Warrior Helmet" then
